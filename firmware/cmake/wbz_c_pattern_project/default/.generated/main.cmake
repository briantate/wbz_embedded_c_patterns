...
add_executable(wbz_c_pattern_project_default_image_AnaU9Auh ${wbz_c_pattern_project_default_library_list})

set_target_properties(wbz_c_pattern_project_default_image_AnaU9Auh PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${wbz_c_pattern_project_default_output_dir})
set_target_properties(wbz_c_pattern_project_default_image_AnaU9Auh PROPERTIES OUTPUT_NAME "default")
set_target_properties(wbz_c_pattern_project_default_image_AnaU9Auh PROPERTIES SUFFIX ".elf")

target_link_libraries(wbz_c_pattern_project_default_image_AnaU9Auh PRIVATE ${wbz_c_pattern_project_default_default_XC32_FILE_TYPE_link})


# Add the link options from the rule file.
wbz_c_pattern_project_default_link_rule(wbz_c_pattern_project_default_image_AnaU9Auh)
...
add_dependencies(wbz_c_pattern_project_default_Bin2Hex wbz_c_pattern_project_default_image_AnaU9Auh)
...
if(enable_dependent_codewbz_c_pattern_project_default_AnaU9Auh)
    add_custom_command(
        OUTPUT ${wbz_c_pattern_project_default_output_dir}/${sourceFileNamewbz_c_pattern_project_default_AnaU9Auh}.c
        COMMAND ${MP_BIN2HEX} --image ${wbz_c_pattern_project_default_full_path_to_image} --image-generated-c ${sourceFileNamewbz_c_pattern_project_default_AnaU9Auh}.c --image-generated-h ${sourceFileNamewbz_c_pattern_project_default_AnaU9Auh}.h --image-copy-mode ${modewbz_c_pattern_project_default_AnaU9Auh} --image-offset ${addresswbz_c_pattern_project_default_AnaU9Auh}
        WORKING_DIRECTORY ${wbz_c_pattern_project_default_output_dir}
        DEPENDS wbz_c_pattern_project_default_image_AnaU9Auh)
    add_custom_target(
        wbz_c_pattern_project_default_processed_fileimage_AnaU9Auh 
        DEPENDS ${wbz_c_pattern_project_default_output_dir}/${sourceFileNamewbz_c_pattern_project_default_AnaU9Auh}.c
        )
    add_library(
        wbz_c_pattern_project_default_processed_file_objectimage_AnaU9Auh
        OBJECT
        EXCLUDE_FROM_ALL
        ${wbz_c_pattern_project_default_output_dir}/${sourceFileNamewbz_c_pattern_project_default_AnaU9Auh}.c)
    add_dependencies(wbz_c_pattern_project_default_processed_file_objectimage_AnaU9Auh wbz_c_pattern_project_default_processed_fileimage_AnaU9Auh)
    add_library(
        wbz_c_pattern_project_default_dependent_image_AnaU9Auh
        INTERFACE
        EXCLUDE_FROM_ALL)
    target_link_libraries(wbz_c_pattern_project_default_dependent_image_AnaU9Auh
    INTERFACE    
 wbz_c_pattern_project_default_processed_file_objectimage_AnaU9Auh)
endif()
